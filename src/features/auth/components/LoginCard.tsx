        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg font-light leading-relaxed text-neutral-400">
              "This platform has completely streamlined our sprint cycles and cross-team collaboration. The real-time tracking is unmatched."
            </p>
            <footer className="text-sm font-medium text-neutral-200">Engineering Lead, Acme Corp</footer>
          </blockquote>
        </div>
      </div>
